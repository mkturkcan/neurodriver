...
class Aggregator(BaseDendriteModel):
    ...
    def run_step(self, update_pointers, st=None):
        '''print(
                        ...
                        self.access_buffers['g'].parr,                     #P
                        self.access_buffers['g'].ld,                          #i
                        self.access_buffers['g'].current,                     #i
                        self.access_buffers['g'].buffer_length,               #i
                        self.params_dict['conn_data']['g']['delay'],  #P
                        self.params_dict['conn_data']['g']['reverse'],#P
                        self.params_dict['pre']['g'],                 #P
                        self.params_dict['npre']['g'],                #P
                        self.params_dict['cumpre']['g'],              #P
                        self.access_buffers['V'].parr,                     #P
                        self.access_buffers['V'].ld,                          #i
                        self.access_buffers['V'].current,                     #i
                        self.params_dict['pre']['V']]  ) '''   
